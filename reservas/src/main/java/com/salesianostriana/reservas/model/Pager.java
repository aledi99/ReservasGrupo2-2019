...
public class Pager {
	...
	public Pager(int totalPages, int currentPage, int buttonsToShow) {
		...
		// Si el número total de páginas es menor o igual que el número de botones a
		// mostrar
		if (totalPages <= getButtonsToShow()) {
			...
			// queda en el intervalo [currentPage - halfPagesToShow --> currentPage <--
			// totalPages]
	...
	/**
	 * Método que establece el número de botones a mostrar. Como restricción, se
	 * impone que este número tenga que ser par.
	 * 
